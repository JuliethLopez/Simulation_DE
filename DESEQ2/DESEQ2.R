...
basedir <- "/lustre/scratch123/hgi/projects/jaguar_analysis/analysis/jl38/Simulation_DE"
setwd("/lustre/scratch123/hgi/projects/jaguar_analysis/analysis/jl38/Simulation_DE")
outdir <- "/lustre/scratch123/hgi/projects/jaguar_analysis/analysis/jl38/Simulation_DE/figures"
source("/lustre/scratch123/hgi/projects/jaguar_analysis/analysis/jl38/Simulation_DE/Functions.R")
...
for (level in levels(deseq2_matrix$Cluster)){
  ...
  print(paste0("Finished DESEQ for:", level))
}
...
write.csv(DE_deseq2_groups, file = "DE_deseq2_original.csv", row.names = TRUE)
...
#deseq_results_filtered = DE_classes(DE_deseq2_groups, min_pct_difference = 0.2, max_p_val_adj = 0.05, type="predicted_deseq")
